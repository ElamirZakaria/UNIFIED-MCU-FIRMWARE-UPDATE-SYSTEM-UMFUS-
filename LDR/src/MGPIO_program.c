 ...
 * 				Mohammed Hassan
 * 				Mohammed Reda
 * @brief   * General Purpose I/O Driver works by taking a pin ID as an input and analyzing the input number to get
...
STD_error_t MGPIO_stderrSetPinMode(u8 ARG_u8PinID, u8 ARG_u8PinMode)
{
	...
	if(ARG_u8PinID <= MGPIO_PIN_C15 && ARG_u8PinMode <= MGPIO_MODE_AF_OPENDRAIN_50MHZ)
	{
